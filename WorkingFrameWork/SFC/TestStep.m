...
-(BOOL)StepSFC_CheckUploadSN:(BOOL)isUploadSFC Option:(NSString*)option sn:(NSString *)sn testResult:(NSString*)testResult startTime:(NSString*)startTime testArgument:(NSArray*)array
{
    ...
    if(isUploadSFC)
    {
        ...
        if ([option isEqualToString:@"isPassOrNot"]) {
            ...
            [[BYDSFCManager Instance] Option:option checkSerialNumber:sn testResult:nil startTime:startTime testArgument:nil];
        }
            ...
            [[BYDSFCManager Instance] Option:option checkSerialNumber:sn testResult:testResult startTime:startTime testArgument:array];
        }
